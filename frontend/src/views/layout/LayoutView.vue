  ...
  <el-container class="layout-container">
    <el-header class="layout-header">
      <div class="header-left">
        ...
        <span class="logo-text">AI智能穿搭生成系统</span>
      </div>
...
async function submitPassword() {
  try { await updatePassword(pwdForm.value); ElMessage.success('密码修改成功'); pwdDialogVisible.value = false; pwdForm.value = { oldPassword: '', newPassword: '' } } catch(e) {}
}
...
.layout-aside { background-color: #1d1e1f; }
